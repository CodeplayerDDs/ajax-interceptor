...
export default class Main extends Component {
    constructor() {
        ...
        // 获取该页面的content发给iframe的消息
        chrome.runtime.onMessage.addListener((data) => {
            let { type, to, url, match } = data;
            debugger;
    ...
    handleSwitchChange = () => {
        window.setting.ajaxInterceptor_switchOn = !window.setting
        ...
        return (
            <div className="main">
                ...
                >
                    ...
                    <div
                        ref={(ref) => (this.addBtnRef = ref)}
                        className="wrapper-btn-add"
                    >
                        <Button
                            className={`btn-add ${
                                window.setting.ajaxInterceptor_switchOn
